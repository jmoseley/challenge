...
let enumsMap: { [index: string]: any } = {
  ...
  'RunningRace.MeasurementPreferenceEnum':
    RunningRace.MeasurementPreferenceEnum,
...
export class ActivitiesApi {
  ...
  public createActivity(
    ...
    photoIds?: string,
    commute?: number,
  ): Promise<{ response: http.ClientResponse; body: DetailedActivity }> {
    ...
    if (_private !== undefined) {
      localVarFormParams['private'] = ObjectSerializer.serialize(
        _private,
        'number',
      );
    }
    ...
    if (photoIds !== undefined) {
      localVarFormParams['photo_ids'] = ObjectSerializer.serialize(
        photoIds,
        'string',
      );
    }
  ...
  public getCommentsByActivityId(
    ...
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: Array<Comment> }> {
    const localVarPath =
      this.basePath +
    ...
    return new Promise<{ response: http.ClientResponse; body: Array<Comment> }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
  ...
  public getKudoersByActivityId(
    ...
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: Array<SummaryAthlete> }> {
    const localVarPath =
      this.basePath +
  ...
  public getLapsByActivityId(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: Array<Lap> }> {
    const localVarPath =
      this.basePath +
    ...
    return new Promise<{ response: http.ClientResponse; body: Array<Lap> }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
  ...
  public getLoggedInAthleteActivities(
    ...
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: Array<SummaryActivity> }> {
  ...
  public getZonesByActivityId(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: Array<ActivityZone> }> {
    const localVarPath =
      this.basePath +
...
export class AthletesApi {
   ...
   */
  public getLoggedInAthlete(): Promise<{
    response: http.ClientResponse;
   ...
   * @summary Get Zones
   */
  public getLoggedInAthleteZones(): Promise<{
    response: http.ClientResponse;
    body: Zones;
  }> {
    ...
    return new Promise<{ response: http.ClientResponse; body: Zones }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
  ...
  public getStats(
    ...
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: ActivityStats }> {
    const localVarPath =
      this.basePath +
    ...
    return new Promise<{ response: http.ClientResponse; body: ActivityStats }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
  ...
  public updateLoggedInAthlete(
    body: DetailedAthlete,
  ): Promise<{ response: http.ClientResponse; body: DetailedAthlete }> {
    const localVarPath = this.basePath + '/athlete';
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
    ...
    if (body === null || body === undefined) {
      throw new Error(
        'Required parameter body was null or undefined when calling updateLoggedInAthlete.',
      );
    }
...
export class ClubsApi {
  ...
  public getClubById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: DetailedClub }> {
    const localVarPath =
      this.basePath +
    ...
    return new Promise<{ response: http.ClientResponse; body: DetailedClub }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
  ...
  public getLoggedInAthleteClubs(
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: Array<SummaryClub> }> {
  ...
  public joinClubById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: MembershipApplication }> {
    const localVarPath =
      this.basePath +
      '/clubs/{id}/join'.replace(
        '{' + 'id' + '}',
        encodeURIComponent(String(id)),
      );
    let localVarQueryParameters: any = {};
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling joinClubById.',
      );
    }
   ...
   * @param id The identifier of the club.
   */
  public leaveClubById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: MembershipApplication }> {
    const localVarPath =
      this.basePath +
      '/clubs/{id}/leave'.replace(
        '{' + 'id' + '}',
        encodeURIComponent(String(id)),
      );
    let localVarQueryParameters: any = {};
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling leaveClubById.',
      );
    }
...
export class GearsApi {
  ...
  public getGearById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: DetailedGear }> {
    const localVarPath =
      this.basePath +
    ...
    return new Promise<{ response: http.ClientResponse; body: DetailedGear }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
...
export class RoutesApi {
  ...
  public getRouteById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: Route }> {
    const localVarPath =
      this.basePath +
    ...
    return new Promise<{ response: http.ClientResponse; body: Route }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
  ...
  public getRoutesByAthleteId(
    ...
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: Array<Route> }> {
    const localVarPath =
      this.basePath +
      '/athletes/{id}/routes'.replace(
        '{' + 'id' + '}',
        encodeURIComponent(String(id)),
      );
    let localVarQueryParameters: any = {};
    ...
    return new Promise<{ response: http.ClientResponse; body: Array<Route> }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
...
export class RunningRacesApi {
   ...
   */
  public getRunningRaceById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: RunningRace }> {
    const localVarPath =
      this.basePath +
      '/running_races/{id}'.replace(
        '{' + 'id' + '}',
        encodeURIComponent(String(id)),
      );
    let localVarQueryParameters: any = {};
    ...
    return new Promise<{ response: http.ClientResponse; body: RunningRace }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
   ...
   */
  public getRunningRaces(
    year?: number,
  ): Promise<{ response: http.ClientResponse; body: Array<RunningRace> }> {
...
export class SegmentEffortsApi {
  ...
  public getEffortsBySegmentId(
    ...
    const localVarPath =
      this.basePath +
      '/segments/{id}/all_efforts'.replace(
        '{' + 'id' + '}',
        encodeURIComponent(String(id)),
      );
    let localVarQueryParameters: any = {};
  ...
  public getSegmentEffortById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: DetailedSegmentEffort }> {
    const localVarPath =
      this.basePath +
...
export class SegmentsApi {
  ...
  public exploreSegments(
    ...
    minCat?: number,
    maxCat?: number,
  ): Promise<{ response: http.ClientResponse; body: ExplorerResponse }> {
  ...
  public getLeaderboardBySegmentId(
    ...
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: SegmentLeaderboard }> {
    const localVarPath =
      this.basePath +
      '/segments/{id}/leaderboard'.replace(
        '{' + 'id' + '}',
        encodeURIComponent(String(id)),
      );
    let localVarQueryParameters: any = {};
    ...
    if (gender !== undefined) {
      localVarQueryParameters['gender'] = ObjectSerializer.serialize(
        gender,
        'string',
      );
    }
    ...
    if (ageGroup !== undefined) {
      localVarQueryParameters['age_group'] = ObjectSerializer.serialize(
        ageGroup,
        'string',
      );
    }
    ...
    if (weightClass !== undefined) {
      localVarQueryParameters['weight_class'] = ObjectSerializer.serialize(
        weightClass,
        'string',
      );
    }
    ...
    if (following !== undefined) {
      localVarQueryParameters['following'] = ObjectSerializer.serialize(
        following,
        'boolean',
      );
    }
    ...
    if (clubId !== undefined) {
      localVarQueryParameters['club_id'] = ObjectSerializer.serialize(
        clubId,
        'number',
      );
    }
    ...
    if (dateRange !== undefined) {
      localVarQueryParameters['date_range'] = ObjectSerializer.serialize(
        dateRange,
        'string',
      );
    }
    ...
    if (contextEntries !== undefined) {
      localVarQueryParameters['context_entries'] = ObjectSerializer.serialize(
        contextEntries,
        'number',
      );
    }
  ...
  public getLoggedInAthleteStarredSegments(
    page?: number,
    perPage?: number,
  ): Promise<{ response: http.ClientResponse; body: Array<SummarySegment> }> {
  ...
  public getSegmentById(
    id: number,
  ): Promise<{ response: http.ClientResponse; body: DetailedSegment }> {
    const localVarPath =
      this.basePath +
      '/segments/{id}'.replace(
        '{' + 'id' + '}',
...
export class StreamsApi {
  ...
  public getActivityStreams(
    ...
    keys: Array<string>,
    keyByType: boolean,
  ): Promise<{ response: http.ClientResponse; body: StreamSet }> {
    const localVarPath =
      this.basePath +
    ...
    return new Promise<{ response: http.ClientResponse; body: StreamSet }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
...
export class UploadsApi {
  ...
  public createUpload(
    ...
    dataType?: string,
    externalId?: string,
  ): Promise<{ response: http.ClientResponse; body: Upload }> {
    ...
    return new Promise<{ response: http.ClientResponse; body: Upload }>(
      (resolve, reject) => {
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            reject(error);
